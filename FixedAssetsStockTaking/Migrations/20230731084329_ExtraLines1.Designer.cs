...
namespace FixedAssetsStockTaking.Migrations
{
    ...
    [Migration("20230731084329_ExtraLines1")]
    partial class ExtraLines1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FixedAssetsStockTaking.Models.ExtraLine", b =>
                {
                    ...
                    b.HasOne("FixedAssetsStockTaking.Models.MijlocFix", "MijlocFix")
                        .WithMany()
                        .HasForeignKey("MFLine")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Inventar");

                    b.Navigation("MijlocFix");
                });
